package com.nj.mcp.demo.mcpplayground.sec08.host.controller;

import com.nj.mcp.demo.mcpplayground.sec08.host.dto.*;
...
public class McpController {
    ...
    public McpController(ChatClient client, McpSessionManifest mcpSessionManifest,
                         NotificationChannel<UserNotification> notificationChannel,
                         NotificationChannel<UserNotificationResponse> notificationResponseChannel) {
        this.client = client;
