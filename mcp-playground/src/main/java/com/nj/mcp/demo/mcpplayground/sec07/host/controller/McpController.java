package com.nj.mcp.demo.mcpplayground.sec07.host.controller;

import com.nj.mcp.demo.mcpplayground.sec07.host.dto.ChatRequest;
import com.nj.mcp.demo.mcpplayground.sec07.host.dto.McpSessionManifest;
import com.nj.mcp.demo.mcpplayground.sec07.host.dto.NotificationChannel;
import com.nj.mcp.demo.mcpplayground.sec07.host.dto.UserNotification;
...
public class McpController {
    ...
    public Flux<String> chat(@RequestBody ChatRequest request, @RequestHeader("userId") Integer userId) {
        var ctx = Map.<String, Object>of("userId", userId, "progressToken", request.progressToken());
