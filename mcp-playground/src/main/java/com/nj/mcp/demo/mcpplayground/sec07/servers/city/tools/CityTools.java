package com.nj.mcp.demo.mcpplayground.sec07.servers.city.tools;

import com.nj.mcp.demo.mcpplayground.sec07.servers.city.dto.City;
import com.nj.mcp.demo.mcpplayground.sec07.servers.city.dto.Recommendation;
...
public class CityTools {
    ...
    private void initialize(JsonMapper mapper, Resource resource) throws IOException {
        ...
        this.codeToCityMap = cities.stream()
                                    .collect(Collectors.toMap(City::airportCode, City::name));
        this.codeToRecommendationMap = cities.stream()
                                                .collect(Collectors.toMap(City::airportCode, City::recommendation));
    }
}
